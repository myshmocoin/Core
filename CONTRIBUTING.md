Contributing to ShmoCoin Core
============================

The ShmoCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the ShmoCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/shmocoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to shmocoin-qt
...
The following applies to code changes to the ShmoCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall ShmoCoin
Network Protocol consensus changes.

Whether a pull request is merged into ShmoCoin Core rests with the project merge
...
Patches that change ShmoCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ShmoCoin consensus, it must have been
...
The project leader is the release manager for each ShmoCoin Core release.
