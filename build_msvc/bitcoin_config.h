...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The ShmoCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "ShmoCoin Core"
...
#define PACKAGE_NAME "ShmoCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ShmoCoin Core 0.21.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "shmocoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://myshmo.org//"
