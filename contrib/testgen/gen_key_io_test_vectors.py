...
bech32_templates = [
  ...
  ('shmo',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('shmo',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('shmo',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('shmo',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tshmo',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tshmo',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tshmo',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tshmo',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tshmo',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tshmo',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tshmo',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tshmo',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rshmo',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rshmo',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rshmo',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rshmo', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tshmo',   17, 32, Encoding.BECH32M, False, False, False),
  ('rshmo',  3,  1, Encoding.BECH32M, False, False, False),
  ('shmo',   15, 41, Encoding.BECH32M, False, False, False),
  ('tshmo',    0, 16, Encoding.BECH32,  False, False, False),
  ('rshmo',  0, 32, Encoding.BECH32,  True,  False, False),
  ('shmo',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tshmo',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rshmo',  0, 20, Encoding.BECH32,  False, False, True),
  ('shmo',    0, 20, Encoding.BECH32M, False, False, False),
  ('tshmo',    0, 32, Encoding.BECH32M, False, False, False),
  ('rshmo',  0, 20, Encoding.BECH32M, False, False, False),
  ('shmo',    1, 32, Encoding.BECH32,  False, False, False),
  ('tshmo',    2, 16, Encoding.BECH32,  False, False, False),
  ('rshmo', 16, 20, Encoding.BECH32,  False, False, False),
]
