# Support for Output Descriptors in ShmoCoin Core

Since ShmoCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `shmo1...` for mainnet or `tshmo1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing ShmoCoin Core wallets, a convenience function `combo` is
