...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " shmocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  shmocoin-tx [options] <hex-tx> [commands]  Update hex-encoded shmocoin transaction\n" +
            "or:     shmocoin-tx [options] -create [commands]   Create hex-encoded shmocoin transaction\n" +
            "\n";
