...
const char * const BITCOIN_CONF_FILENAME = "shmocoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ShmoCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/ShmoCoin";
#else
    // Unix-like
    return pathRet / ".shmocoin";
#endif
#endif
}
