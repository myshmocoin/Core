...
"""Verify that starting shmocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start shmocoin with -h for help text")
        ...
        self.log.info("Start shmocoin with -version for version information")
        ...
        self.log.info("Start shmocoind with -fakearg to make sure it does not start")
